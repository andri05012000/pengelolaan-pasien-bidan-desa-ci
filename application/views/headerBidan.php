                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                <a href="<?php echo base_url('berandaBidan'); ?>" class="waves-effect"><i class="ti-home"></i>
                                 <span> Beranda </span> <span></span></a>
                               
                            </li>

                            <li class="has_sub">
                                <a href="<?php echo base_url('bidan/analisa'); ?>"class="waves-effect"><i class=" md-accessibility"></i> Analisa Penyakit </a>

                            </li>

                            <li class="has_sub">
                                 <a href="<?php echo base_url('/bidan/resep'); ?>" class="waves-effect"><i class=" md-assignment"></i> Resep Obat </a>

                            ...
                            <?php 
                                    ...
                                    foreach($analisa->result() as $u){ 
                                        ...
                                        <td>
                                            ...
                                            <a href ='#' class='on-default edit-row btn btn-primary' data-toggle='modal' data-target='#custom-width-modal' onClick=\"SetInput('".$u->id_analisa."','".$u->id_pendaftaran."','".$u->analisa."')\" class='col-sm-6 col-md-4 col-lg-3'>
                                            <i class='ti-pencil'></i></a>
                                           
                                          
                                            <a href='#' class='on-default default-row btn btn-danger' data-toggle='modal' data-target='#delete-modal' onClick=\"setInput1('".$u->id_analisa."','".$u->id_pendaftaran."','".$u->analisa."')\" class='col-sm-6 col-md-4 col-lg-3'>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="<?php echo base_url('bidan/analisa/add'); ?>" method="post">
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="hidden" id="id_analisa" name="id_analisa">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="field-3" class="control-label">Analisa Penyakit</label>
                                   <input type="text" class="form-control" id="analisa" name="analisa" required>
                                </div>
                            </div>
                        </div>  
                        <td>
            ...
            <div class="modal-dialog" style="width:55%;">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form action="<?php echo base_url('bidan/analisa/delete'); ?>" method="post" class="form-horizontal" role="form">
                    </div>
                    <div class="modal-body">
                        <h4>Konfirmasi</h4>
	                ...
	                function SetInput(id_analisa, id_pendaftaran, analisa) {
	                    document.getElementById('id_analisa').value = id_analisa;
	                    document.getElementById('id_pendaftaran').value = id_pendaftaran;
	                    document.getElementById('analisa').value = analisa;
	                }
	                function setInput1(id_analisa, id_pendaftaran, analisa) {
	                    document.getElementById('id_analisa1').value = id_analisa;
                        document.getElementById('id_pendaftaran1').value = id_pendaftaran;
                        document.getElementById('analisa1').value = analisa;
	                }
	                function ResetInput(id_analisa, id_pendaftaran, analisa) {
	                    document.getElementById('id_analisa').value = "";
